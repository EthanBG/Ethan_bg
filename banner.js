	...
	var biglogo = createElement({src: "img/mini/biglogo.png", left: 55, top: 85, width: 190, height: 81});
	var btnblue = createElement({src: "img/mini/btnblue.png", left: 147, top: 21, width: 20, height: 20, cursor: "pointer", zIndex: 99999});
	var btnred = createElement({src: "img/mini/btnred.png", left: 201, top: 21, width: 20, height: 20, cursor: "pointer", zIndex: 99999});
	var btnyellow = createElement({src: "img/mini/btnyellow.png", left: 174, top: 21, width: 20, height: 20, cursor: "pointer", zIndex: 99999});
	var carprofile = createElement({src: "img/mini/carprofile.png", top: 69, width: 300, height: 140});
	var minilogo = createElement({src: "img/mini/minilogo.png", left: 225, top: 209, width: 60, height: 26});
	var minibw = createElement({src: "img/mini/minibw.png", left: 26, top: 70 -5, width: 299, height: 159, parent: black_frame});
	var miniblue = createElement({src: "img/mini/miniblue.png", left: 68, top: 108, width: 222, height: 68});
	var minired = createElement({src: "img/mini/minired.png", left: 38, top: 108, width: 222, height: 68});
	var miniyellow = createElement({src: "img/mini/miniyellow.png", left: 38, top: 108, width: 222, height: 68});
	var cta_frame = createRectangle(10, 209, 144, 31, "#000000")
	var ctaarrow = createElement({src: "img/mini/ctaarrow.png", left: 20 - 10, top: 221 - 209, width: 7, height: 8, parent: cta_frame});
	var ctaarrow_2 = createElement({src: "img/mini/ctaarrow.png", left: 25 - 10, top: 221 - 209, width: 7, height: 8, parent: cta_frame});
